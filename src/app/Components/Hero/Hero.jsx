...
export default function Hero() {
  return (
    <section className="w-full flex items-center py-10 bg-gray-950 dark:bg-black light:bg-[#f8f8f8]  relative overflow-hidden">
      <div className="relative z-10 grid grid-cols-2 items-center w-full md:w-10/12 mx-auto px-2 md:px-8 gap-8 md:gap-90">
        <div>
          ...
          <p className="mt-6 max-w-lg text-gray-700 dark:text-gray-300 light:text-gray-600 leading-relaxed font-semibold">
          ...
          <button className="mt-8 px-8 py-4 bg-[#d61c1c] rounded-xl text-white font-semibold hover:bg-red-700 transition">
            Order Now
          </button>
        </div>
